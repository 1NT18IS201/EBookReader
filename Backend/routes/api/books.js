...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      // const { path, mimetype } = req.files.file1[0];
      const path1 = req.files.file1[0].path;
      const mimetype1 = req.files.file1[0].mimetype;
      // const path2 = req.files.file2[0].path;
      // const mimetype2 = req.files.file2[0].mimetype;
      // const { path2, mimetype2 } = req.files[1];
      console.log(title);
      ...
      const books = new Book({
        ...
        cover,
        file_path1: path1,
        file_mimetype1: mimetype1,
        // file_path2: path2,
        // file_mimetype2: mimetype2,
      });
      console.log("a");
      await books.save();
